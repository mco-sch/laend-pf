...
**6. Ensure LCA connection**\
Make sure, that your brightway2 installation has a project that is called 'laend' and this project includes biosphere flows including the impact category EF v3.1 or adjust these default configurations in `config_pf_auto.py` under #LCA.
For automatic LCA import, see below.
